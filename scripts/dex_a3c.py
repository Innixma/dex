...
def playGameReal(args, screen=Screenparam(), hyperparams=Hyperparam(), screen_number=0, screen_id=-1):
...
hex_train_incongruence_args = Args(
                     mode='train',
                     game='default',
                     env='real',
                     data='default',
...
def main():    
    ...
    runSimulation(hex_train_incongruence_args)
    #args['mode'] = 'Run'
