...
import numpy as np
from hexalys_environment import SuperHexagonProcessor, SuperHexagonEnvironment
...
env = SuperHexagonProcessor(WINDOW_LENGTH)
nb_actions = 3
...
processor = SuperHexagonProcessor(INPUT_SHAPE)
